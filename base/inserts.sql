...
VALUES
('empresa', 'TITAN-ES SEGURIDAD EN ALTURAS', 900123456, 'Bogotá D.C.', 6015555555, 'contacto@titan-es.com', 'empresa123', 3, 1);
...
VALUES
('usuario','Carlos','Ramirez',1,1012345678,'Bogotá',3001111111,'carlos@titan-es.com','123',1,2),

('usuario','Andrea','Morales',1,1023456789,'Bogotá',3002222222,'andrea@titan-es.com','123',1,2),

('usuario','Jorge','Castillo',1,1034567890,'Bogotá',3003333333,'jorge@titan-es.com','123',1,2);
INSERT INTO usuarios(tipo_registro,nombre,apellido,id_tipo, numero_identificacion,direccion,telefono,correo,password_hash,id_empresa,id_rol
)
VALUES

('trabajador','Juan','Perez',1,1091111111,'Bogotá',3101111111,'juan@gmail.com','123',1,3),

('trabajador','Laura','Gomez',3,987654321,'Bogotá',3102222222,'laura@gmail.com','123',1,3),

('trabajador','Miguel','Torres',3,987654322,'Bogotá',3103333333,'miguel@gmail.com','123',1,3),

('trabajador','Camila','Ruiz',1,1094444444,'Bogotá',3104444444,'camila@gmail.com','123',1,3),

('trabajador','David','Rojas',3,987654323,'Bogotá',3105555555,'david@gmail.com','123',1,3),

('trabajador','Sofia','Mendoza',1,1096666666,'Bogotá',3106666666,'sofia@gmail.com','123',1,3),

('trabajador','Daniel','Vargas',1,1097777777,'Bogotá',3107777777,'daniel@gmail.com','123',1,3);
