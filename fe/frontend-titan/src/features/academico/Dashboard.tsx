...
// TODO: estos valores son estáticos (placeholder). Cuando exista un endpoint de
// resumen/estadísticas en el backend (p. ej. GET /api/dashboard/resumen), reemplazar
// por un useState + useEffect igual que en Calendario.tsx.
function Dashboard() {
  return (
    <div>
